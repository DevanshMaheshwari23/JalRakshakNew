...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'home1Copy',
          path: '/home1Copy',
          builder: (context, params) => const Home1CopyWidget(),
        ),
        FFRoute(
          name: 'auth_2_Create',
          path: '/auth2Create',
        ...
        FFRoute(
          name: 'locationCopy',
          path: '/locationCopy',
          builder: (context, params) => const LocationCopyWidget(),
        ),
        FFRoute(
          name: 'ProblemStatus',
          path: '/problemStatus',
          builder: (context, params) => const ProblemStatusWidget(),
        ),
        FFRoute(
          name: 'NGOpage',
          path: '/nGOpage',
          builder: (context, params) => const NGOpageWidget(),
        ),
        FFRoute(
          name: 'Admin',
          path: '/admin',
        ...
        FFRoute(
          name: 'Admin_Authlogin',
          path: '/adminAuthlogin',
          builder: (context, params) => const AdminAuthloginWidget(),
        ),
        FFRoute(
          name: 'Admin_Authcreate',
          path: '/adminAuthcreate',
          builder: (context, params) => const AdminAuthcreateWidget(),
        )
...
class FFRoute {
  ...
  GoRoute toRoute(AppStateNotifier appStateNotifier) => GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = page; // Skip loading indicator entirely
